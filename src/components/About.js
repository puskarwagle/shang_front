...
function About() {
  return (
    <section id="about" className="p-3 p-sm-3 p-md-5 row d-flex border">
      <div className="col-md-6 col-lg-8 col-xl-12 d-inline-flex flex-column mb-4">
      ...
      <div className="col-md-12 col-lg-12 col-xl-12 border p-0">
